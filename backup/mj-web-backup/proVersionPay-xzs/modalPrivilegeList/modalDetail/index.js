...
export default class IntroduceProfession extends React.PureComponent {
  ...
  nextIntroduce = () => {
    ...
    collectData({ moduleName, key: 'clickViewMediaDirection', info: { direction: 'Next' } });
  ...
  prevIntroduce = () => {
    const { moduleName } = this.props;
    collectData({ moduleName, key: 'clickViewMediaDirection', info: { direction: 'Prev' } });
    ...
    this.setState(
      ...
      () => {
        this.___addToStorage('Prev');
      }
    );
  };

  ___addToStorage = direction => {
